            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="navbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="" id="pref"><a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="button">Preference <span class="caret"></span></a>
                        ...
                        <li class="active" id="tsc"><a href="../TSC/"><span class="glyphicon glyphicon-education"></span> Teachers and Students Center</a></li>
